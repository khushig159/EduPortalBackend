...
const authRecruiterController=require('../controller/auth-mentor')
const authseeker=require('../middleware/auth-user')
const authrecruiter=require('../middleware/auth-mentor')
